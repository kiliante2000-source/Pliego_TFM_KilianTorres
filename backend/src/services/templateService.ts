...
function buildPortadaEditorial(): DocumentModel {
  const w = 1080;
  const h = 1350;
  const doc = createEmptyDocument('Portada editorial', w, h);
  ...
  doc.pages[0].elements = [
    // L-frame left
    {
      ...
      fillGradient: {
        ...
        stops: [
          { offset: 0, color: '#4F80FF' },
          { offset: 0.35, color: '#FF4EDB' },
          { offset: 0.65, color: '#A855F7' },
          { offset: 1, color: '#B2FF3A' },
        ],
      },
    },
    // L-frame bottom
    {
      ...
      fillGradient: {
        ...
        stops: [
          { offset: 0, color: '#4F80FF' },
          { offset: 0.4, color: '#A855F7' },
          { offset: 0.7, color: '#FF4EDB' },
    ...
    // Orb
    {
      ...
      fillGradient: {
        ...
        stops: [
          ...
          { offset: 0.7, color: '#4F80FF' },
          { offset: 1, color: '#0B0E11' },
        ],
      },
      opacity: 0.95,
      animation: { preset: 'scaleIn', duration: 1400, trigger: 'load' },
    ...
    // Badge plate
    {
      ...
      ...base(3),
      fill: '#121826',
      stroke: 'rgba(244,246,248,0.28)',
      strokeWidth: 1,
      cornerRadius: 4,
      animation: { preset: 'fadeUp', delay: 80, trigger: 'load' },
    },
    {
      id: id(),
      type: 'text',
      ...
      animation: { preset: 'fadeUp', delay: 100, trigger: 'load' },
    },
    // Wordmark plate
    {
      id: id(),
      ...
      ...base(5),
      fill: '#152238',
      animation: { preset: 'slideRight', delay: 140, duration: 900, trigger: 'load' },
    },
    {
      id: id(),
      type: 'text',
      ...
      animation: { preset: 'fadeUp', delay: 200, duration: 900, trigger: 'load' },
    },
    // Line 1 plate
    {
      id: id(),
      ...
      ...base(7),
      fill: '#152238',
      animation: { preset: 'slideRight', delay: 280, duration: 850, trigger: 'load' },
    },
    {
      id: id(),
      type: 'text',
      ...
      animation: { preset: 'fadeUp', delay: 320, trigger: 'load' },
    },
    // Line 2 plate
    {
      id: id(),
      ...
      ...base(9),
      fill: '#152238',
      animation: { preset: 'slideRight', delay: 360, duration: 850, trigger: 'load' },
    },
    {
      id: id(),
      type: 'text',
      ...
      animation: { preset: 'fadeUp', delay: 400, trigger: 'load' },
    },
  ];
  return doc;
}
